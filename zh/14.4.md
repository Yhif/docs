...
![](/zh/images/14.4.github.png?raw=true)

图14.4 显示带有登录按钮的首页

然后点击链接出现如下界面：

![](/zh/images/14.4.github2.png?raw=true)

图14.5 点击登录按钮后显示github的授权页

然后点击Authorize app就出现如下界面：

![](/zh/images/14.4.github3.png?raw=true)
...
## links
   * <a router-link="/">目录</a>
   * 上一节: <a router-link="/zh/14.3">表单及验证支持</a>
   * 下一节: <a router-link="/zh/14.5">多语言支持</a>