...
![](/zh/images/14.6.pprof.png?raw=true)

图14.7 系统当前goroutine、heap、thread信息

点击goroutine我们可以看到很多详细的信息：

![](/zh/images/14.6.pprof2.png?raw=true)
...
![](/zh/images/14.6.pprof3.png?raw=true)

图14.9 展示的执行流程信息

## links
   * <a router-link="/">目录</a>
   * 上一节: <a router-link="/zh/14.5">多语言支持</a>
   * 下一节: <a router-link="/zh/14.7">小结</a>