...
![](/zh/images/2.5.rect_func_without_receiver.png?raw=true)
...
![](/zh/images/2.5.shapes_func_with_receiver_cp.png?raw=true)
...
## links
   * <a router-link="/">目录</a>
   * 上一章: <a router-link="/zh/02.4">struct 类型</a>
   * 下一节: <a router-link="/zh/02.6">interface</a>
