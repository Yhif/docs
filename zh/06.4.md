...
![](/zh/images/6.4.hijack.png?raw=true)
...
![](/zh/images/6.4.cookie.png?raw=true)
...
![](/zh/images/6.4.setcookie.png?raw=true)

图6.6 模拟cookie

回车后，你将看到如下内容：

![](/zh/images/6.4.hijacksuccess.png?raw=true)
...
## links
   * <a router-link="/">目录</a>
   * 上一节: <a router-link="/zh/06.3">session存储</a>
   * 下一节: <a router-link="/zh/06.5">小结</a>
