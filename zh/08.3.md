...
![](/zh/images/8.3.rest2.png?raw=true)
...
![](/zh/images/8.3.rest.png?raw=true)
...
![](/zh/images/8.3.rest3.png?raw=true)
...
## links
   * <a router-link="/">目录</a>
   * 上一节: <a router-link="/zh/08.2">WebSocket</a>
   * 下一节: <a router-link="/zh/08.4">RPC</a>
