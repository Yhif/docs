...
![](/zh/images/2.2.basic.png?raw=true)
...
![](/zh/images/2.2.array.png?raw=true)
...
![](/zh/images/2.2.slice.png?raw=true)
...
![](/zh/images/2.2.slice2.png?raw=true)
...
![](/zh/images/2.2.makenew.png?raw=true)
...
## links
   * <a router-link="/">目录</a>
   * 上一章: <a router-link="/zh/02.1">你好，Go</a>
   * 下一节: <a router-link="/zh/02.3">流程和函数</a>
