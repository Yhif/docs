...
![](/zh/images/6.1.cookie2.png?raw=true)
...
![](/zh/images/6.1.session.png?raw=true)
...
![](/zh/images/6.1.cookie.png?raw=true)
...
## links
   * <a router-link="/">目录</a>
   * 上一节: <a router-link="/zh/06.0">session 和数据存储</a>
   * 下一节: <a router-link="/zh/06.2">Go 如何使用 session</a>
